...
namespace SD_340_W22SD_Lab4.Models
{
    ...
    {
        private readonly SD_340_W22SD_Lab4Context _context;

        public StopsController(SD_340_W22SD_Lab4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Street,Name,Direction")] Stop stop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Street,Name,Direction")] Stop stop)
        {
            if (id != stop.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SD_340_W22SD_Lab4Context.Stop'  is null.");
            }
            var stop = await _context.Stop.FindAsync(id);
            if (stop != null)
            {
